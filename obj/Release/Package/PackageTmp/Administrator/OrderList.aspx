...
<style>
    ...
    .page-header-row{ display:flex; align-items:center; justify-content:space-between; gap:12px; margin-top:12px; flex-wrap:wrap; }
    .title-wrap h2{ margin:0; font-weight:800; letter-spacing:.2px; }
    .subtitle{ color:#777; margin-top:4px; font-size:12px; }
    .top-actions{ display:flex; align-items:center; gap:10px; flex-wrap:wrap; }

    .kpi-tabs { display:inline-flex; gap:0; border:1px solid #e5e5e5; border-radius:999px; overflow:hidden; background:#fff; box-shadow:0 6px 16px rgba(0,0,0,.06);}
    .kpi-tab { padding:8px 14px; font-weight:700; font-size:12px; color:#555; background:#fff; border:0; outline:none; text-decoration:none !important; display:inline-block; }
    .kpi-tab:hover { background:#f6f6f6; }
    .kpi-tab.active { background:#0d6efd; color:#fff; }
    .kpi-tab + .kpi-tab { border-left:1px solid #e5e5e5; }

    .kpi-grid{ display:flex; gap:16px; flex-wrap:wrap; margin-top:14px; margin-bottom:12px; }
    .kpi-card{ background:#fff; border:1px solid #eee; border-radius:12px; box-shadow:0 6px 18px rgba(0,0,0,.06); padding:16px 18px; min-width:260px; flex:1; }
    .kpi-title{ color:#666; font-weight:700; font-size:12px; margin-bottom:6px; display:flex; justify-content:space-between; align-items:center; gap:8px; }
    .kpi-value{ font-size:28px; font-weight:900; line-height:1.1; margin-bottom:4px; }
    .kpi-sub{ color:#888; font-size:12px; }

    .filters{ background:#fff; border:1px solid #eee; border-radius:12px; box-shadow:0 6px 18px rgba(0,0,0,.06); padding:14px; margin:8px 0 14px 0; }
    .filters .form-control{ height:38px; }
    .filters .row{ margin-left:-8px; margin-right:-8px; }
    .filters [class^="col-"]{ padding-left:8px; padding-right:8px; }

    .grid-wrap{ background:#fff; border:1px solid #eee; border-radius:12px; box-shadow:0 6px 18px rgba(0,0,0,.06); padding:10px 10px 2px 10px; }
    .table>thead>tr>th{ background:#fafafa; border-bottom:1px solid #eee; }
    ...
    .status-pill{ display:inline-block; padding:6px 10px; border-radius:999px; font-weight:800; font-size:12px; border:1px solid rgba(0,0,0,.06); }
    ...
    .pagination-ys table > tbody > tr > td > span {
        float:left; padding:8px 12px; margin-left:-1px;
        border:1px solid #ddd; background:#fff; color:#0d6efd; text-decoration:none;
    }
    .pagination-ys table > tbody > tr > td > span{ background:#f5f5f5; color:#999; }
    .pagination-ys table > tbody > tr > td:first-child > a,
    .pagination-ys table > tbody > tr > td:first-child > span{ border-top-left-radius:8px; border-bottom-left-radius:8px; }
    .pagination-ys table > tbody > tr > td:last-child > a,
    .pagination-ys table > tbody > tr > td:last-child > span{ border-top-right-radius:8px; border-bottom-right-radius:8px; }
    ...
    .todo-head{ display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap; }
    .todo-title{ font-weight:900; font-size:14px; }
    .todo-sub{ color:#777; font-size:12px; margin-top:2px; }
    .todo-actions{ display:flex; gap:8px; align-items:center; flex-wrap:wrap; }
</style>
...
<asp:UpdatePanel ID="upMain" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
    <ContentTemplate>
        ...
        <!-- ✅ Unprocessed / Pending (OrderStatus 1-2) -->
        <div class="todo-wrap">
            <div class="todo-head">
                <div>
        ...
        <div class="filters">
            <asp:Panel ID="pnlFilters" runat="server" DefaultButton="btnApplyFilters">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label>Search (Order/Buyer/Country)</label>
        ...
        <div class="text-muted" style="margin:6px 2px 10px 2px;">
            Total (main grid): <asp:Label ID="lblTotalCount" runat="server" Text="0"></asp:Label>
        </div>

        <!-- Main grid (default: OrderStatus 3-4) -->
        <div class="grid-wrap">
