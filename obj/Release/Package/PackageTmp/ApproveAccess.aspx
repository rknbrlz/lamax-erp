<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveAccess.aspx.cs" Inherits="Feniks.ApproveAccess" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title>Approve Access | lamaX</title>
...
<body>
    <form id="form1" runat="server" class="card">
        <div class="title">Approve Access</div>

        <asp:Panel ID="pnlOk" runat="server" Visible="false" CssClass="alert alert-success" style="border-radius:10px;">
            <strong>Approved.</strong> User created/activated and credentials emailed.
        </asp:Panel>
